...
public class NFSnackBar extends JFrame
                      implements ActionListener
{
  private static final String MY_PASSWORD = "jinx";
  private NFVendingMachine machine1, machine2, machine3;
  ...
  public NFSnackBar()
  {
    ...
    machine1 = new NFVendingMachine("Java", brandColor1, 45, coin);
    machine2 = new NFVendingMachine("JApple", brandColor2, 50, coin);
    machine3 = new NFVendingMachine("Jinx", brandColor3, 35, coin);
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    {
      // double amt = NFVendor.getTotalSales();
      machine1.reload();
      machine2.reload();
      machine3.reload();
  ...
  {
    NFSnackBar window = new NFSnackBar();
