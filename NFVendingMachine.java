...
public class NFVendingMachine extends JPanel
                            implements ActionListener
{
  private static final int FULL_STOCK = 5;
  private JButton deposit25c, deposit10c, deposit5c, go;
  private JTextField display;
  private NFVendor NFVendor;
  boolean trayFull;
  Color brandColor;
  String brandName;

  public NFVendingMachine(String brand, Color color, int price, ImageIcon coin)
  {
    ...
    NFVendor = new NFVendor(price, FULL_STOCK);
  }

  public void reload()
  {
    NFVendor.setStock(FULL_STOCK);
    display.setText(" " + NFVendor.getDeposit() + "  ");
    repaint();
  }
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    if (b == deposit25c)
      NFVendor.addMoney(25);
    else if (b == deposit10c)
      NFVendor.addMoney(10);
    else if (b == deposit5c)
      NFVendor.addMoney(5);
    else if (b == go)
    {
      trayFull = NFVendor.makeSale();
      int change = NFVendor.getChange();
